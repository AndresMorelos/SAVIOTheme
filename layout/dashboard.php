    ...
    <body <?php echo $OUTPUT->body_attributes(); ?>>
        ...
        <div class="page-wrapper">
            ...
            <div id="page" class="container">
                ...
                <div id="page-content-r60-40" class="row-fluid region-addons">
                    <div class="span7">
                        <div class="wrapper">
                            <!-- Start Slideshow -->
                            <?php require_once(dirname(__FILE__).'/slideshow.php'); ?>
                            <!-- End Slideshow -->
                            <?php echo $OUTPUT->blocks('rb-one-left'); ?>
                        </div>
                    </div>
                    <div class="span5">
                        <div class="wrapper">
                            <div class="wrapper">
                                <?php echo $OUTPUT->blocks('rb-one-right'); ?>
                            </div>
                            <div  class="row-fluid ">
                                <div class="span6">
                                    <div class="wrapper">
                                        <?php echo $OUTPUT->blocks('rb-oner-left'); ?>
                                    </div>
                                </div>
                                <div class="span6">
                                    <div class="wrapper">
                                        <?php echo $OUTPUT->blocks('rb-oner-right'); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div id="page-content-r40-60" class="row-fluid region-addons">
                    <div class="span5">
                        <div class="wrapper">
                            <?php echo $OUTPUT->blocks('rb-two-left'); ?>
                        </div>
                    </div>
                    <div class="span7">
                        <div class="wrapper">
                            <?php echo $OUTPUT->blocks('rb-two-right'); ?>
                        </div>
                    </div>
                </div>
